...
export default function NotFound() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-10 px-4 text-center">
      {/* 404 Illustration */}
      ...
      <div className="max-w-md space-y-3">
        ...
        <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
          Oops! Halaman yang Anda cari sepertinya tersesat di lautan lepas, telah dihapus, atau tautan yang dimasukkan salah.
        </p>
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          >
            ...
            <span>Ke Dashboard Afiliasi</span>
          </Link>
          <button
            onClick={() => router.back()}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl text-xs font-bold transition cursor-pointer"
          >
