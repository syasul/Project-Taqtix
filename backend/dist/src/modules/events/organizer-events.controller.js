...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mendapatkan daftar semua event milik organizer login' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Daftar event organizer berhasil diambil.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Event berhasil dibuat.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Event berhasil diperbarui.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Event berhasil dipublikasikan.' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.NOT_FOUND, description: 'Event tidak ditemukan.' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.FORBIDDEN, description: 'Akses ditolak.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('id')),
