...
export class DashboardController {
  ...
  @ApiOperation({
    summary:
      'Mendapatkan rangkuman data penjualan & revenue event (Organizer Only)',
  })
  @ApiResponse({
  ...
  async exportBuyers(
    ...
    const csvContent = await this.dashboardService.getBuyersCsv(
      eventId,
      userId,
    );
  ...
  @ApiOperation({
    summary:
      'Mendapatkan data atribusi performa marketing channel (Organizer Only)',
  })
  @ApiResponse({
    status: HttpStatus.OK,
