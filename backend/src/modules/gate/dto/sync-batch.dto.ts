...
export class ScanLogItemDto {
  ...
  @ApiProperty({ example: '2026-08-20T03:10:00Z', description: 'Waktu pemindaian offline' })
  @IsDateString({}, { message: 'Format tanggal pemindaian tidak valid' })
  scannedAt!: string;
}

export class SyncBatchDto {
  @ApiProperty({ type: [ScanLogItemDto], description: 'Daftar logs scan offline yang akan disinkronkan' })
  @IsArray()
