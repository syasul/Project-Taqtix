...
export class PaymentsController {
  ...
  @ApiOperation({ summary: 'Mendapatkan link/token pembayaran Snap Midtrans untuk order (Public/Buyer)' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Token Snap berhasil dibuat.' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Menerima notifikasi callback webhook dari payment gateway (Public/Webhook)' })
  ...
  @ApiOperation({ summary: 'Mendapatkan status pembayaran pesanan secara polling (Public/Buyer)' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Status pembayaran berhasil diambil.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Pesanan tidak ditemukan.' })
