...
export class CreatePromoCodeDto {
  ...
  @ApiProperty({ example: 25000, description: 'Nilai diskon (bisa nominal atau persentase)' })
  @IsNumber()
  @Min(1, { message: 'Diskon harus lebih besar dari 0' })
  discount!: number;

  @ApiProperty({ example: 100, description: 'Batas maksimum penggunaan kode promo' })
  @IsNumber()
